  ...
  <div class="flex flex-col">
    <label class="flex flex-col">
      ...
      <input
        ...
        class="inline-flex py-2 px-4 border-2 shadow-sm text-sm font-medium rounded-md hover:bg-silver-700 outline-none focus:border-indigo-500 invalid:border-red-500 required:border-red-500"
...
interface Props {
  label: string;
  modelValue: string | number | Ref<string>;
  type?: string;
